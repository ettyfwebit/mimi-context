  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
      ...
      <div className="text-xs text-gray-500 dark:text-gray-400">
        <span className="font-medium">Tip:</span> Press <kbd className="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs">/</kbd> to focus search, 
        <kbd className="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs ml-1">⌘+Enter</kbd> to submit
      </div>
    </form>
  );
});
